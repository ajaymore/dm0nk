...
// src/lib/drizzle/meta/_journal.json
var journal_default = {
  version: "7",
  dialect: "sqlite",
  entries: [
    ...
    },
    {
      ...
      version: "6",
      when: 1733405360317,
      tag: "0003_military_lucky_pierre",
      breakpoints: true
    },
    {
      idx: 4,
...
// src/lib/drizzle/0000_awesome_fixer.sql
var awesome_fixer_default = "CREATE TABLE `notes` (\n	`id` text PRIMARY KEY NOT NULL,\n	`type` text,\n	`data` text,\n	`created_at` text DEFAULT CURRENT_TIMESTAMP NOT NULL,\n	`updated_at` text DEFAULT CURRENT_TIMESTAMP NOT NULL\n);\n";

// src/lib/drizzle/0001_slimy_bloodstorm.sql
var slimy_bloodstorm_default = "CREATE TABLE `notes_versions` (\n	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,\n	`note_id` text NOT NULL,\n	`data` text,\n	`created_at` text DEFAULT CURRENT_TIMESTAMP NOT NULL,\n	FOREIGN KEY (`note_id`) REFERENCES `notes`(`id`) ON UPDATE no action ON DELETE no action\n);\n--> statement-breakpoint\nALTER TABLE `notes` ADD `rand` text DEFAULT '';";

// src/lib/drizzle/0002_mighty_lilandra.sql
var mighty_lilandra_default = "CREATE TABLE `users` (\n	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,\n	`name` text,\n	`email` text,\n	`created_at` text DEFAULT CURRENT_TIMESTAMP NOT NULL\n);\n--> statement-breakpoint\nCREATE UNIQUE INDEX `users_email_unique` ON `users` (`email`);";

// src/lib/drizzle/0003_military_lucky_pierre.sql
var military_lucky_pierre_default = "ALTER TABLE `notes_versions` ADD `updated_at` text DEFAULT CURRENT_TIMESTAMP NOT NULL;";
...
_a18 = entityKind, _b = TableName, _c = OriginalName, _d = Schema, _e = Columns, _f = ExtraConfigColumns, _g = BaseName, _h = IsAlias, _i = IsDrizzleTable, _j = ExtraConfigBuilder;
...
((SQL22) => {
  ...
  _a48 = entityKind;
  __publicField(_Aliased, _a48, "SQL.Aliased");
...
_a25 = entityKind, _b2 = ViewBaseConfig;
...
_a31 = entityKind;
__publicField(Relation, _a31, "Relation");
var _a32;
var Relations = class {
  constructor(table, config) {
    this.table = table;
...
_a32 = entityKind;
__publicField(Relations, _a32, "Relations");
var _a33;
...
_a35 = entityKind;
__publicField(ForeignKeyBuilder2, _a35, "SQLiteForeignKeyBuilder");
var _a36;
...
_a36 = entityKind;
__publicField(ForeignKey2, _a36, "SQLiteForeignKey");
...
_a37 = entityKind;
__publicField(UniqueConstraintBuilder2, _a37, "SQLiteUniqueConstraintBuilder");
var _a38;
...
_a38 = entityKind;
__publicField(UniqueOnConstraintBuilder2, _a38, "SQLiteUniqueOnConstraintBuilder");
var _a39;
...
_a39 = entityKind;
__publicField(UniqueConstraint2, _a39, "SQLiteUniqueConstraint");
...
_a40 = entityKind;
__publicField(SQLiteColumnBuilder, _a40, "SQLiteColumnBuilder");
var _a41;
...
_a41 = entityKind;
__publicField(SQLiteColumn, _a41, "SQLiteColumn");

// node_modules/drizzle-orm/sqlite-core/table.js
var InlineForeignKeys = Symbol.for("drizzle:SQLiteInlineForeignKeys");
var _a42, _b3, _c2, _d2;
...
_a42 = entityKind, _b3 = Table.Symbol.Columns, _c2 = InlineForeignKeys, _d2 = Table.Symbol.ExtraConfigBuilder;
...
_a43 = entityKind;
__publicField(CasingCache, _a43, "CasingCache");
...
_a44 = entityKind;
__publicField(SQLiteViewBase, _a44, "SQLiteViewBase");
...
_a45 = entityKind;
__publicField(SQLiteDialect, _a45, "SQLiteDialect");
var _a46;
...
_a46 = entityKind;
__publicField(SQLiteSyncDialect, _a46, "SQLiteSyncDialect");
var _a47;
...
_a47 = entityKind;
__publicField(SQLiteAsyncDialect, _a47, "SQLiteAsyncDialect");
...
function toQuery(sql2) {
  const sqliteDialect = new SQLiteSyncDialect();
  return sqliteDialect.sqlToQuery(sql2);
}
function migrate(config) {
  const migrations = readMigrationFiles(migrations_default);
  const migrationsTable = config === void 0 ? "__drizzle_migrations" : typeof config === "string" ? "__drizzle_migrations" : config.migrationsTable ?? "__drizzle_migrations";
  const migrationTableCreate = sql`
        CREATE TABLE IF NOT EXISTS ${sql.identifier(migrationsTable)} (
          id integer PRIMARY KEY AUTOINCREMENT NOT NULL,
  ...
  try {
    for (const migration of migrations) {
      if (!lastDbMigration || Number(lastDbMigration.created_at) < migration.folderMillis) {
        for (const stmt2 of migration.sql) {
          log(toQuery(sql.raw(stmt2)).sql);
          db.exec({ sql: toQuery(sql.raw(stmt2)).sql });
        }
        const stmt = toQuery(
